...
Source fingerprint: `fb6ef76` · ⚠️ working tree **DIRTY** (uncommitted src/web changes → derivatives STALE) · package version: `1.0.0` · refreshed: 2026-05-25
...
- eval: 1 capture(s) — snapshots/eval-2026-05-24
- probe: 1 capture(s) — snapshots/mcp-audit-2026-05-23
